...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-npmlist/node_modules/npmlist/build/cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-npmlist/node_modules/npmlist/build/cli.js</span></h1>
    <h2>
        
        Statements: <span class="metric">39.34% <small>(24 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-npmlist/node_modules/npmlist/build/</a> &#187; cli.js</div>
</div>
<div class="body">
...
var executed = false;
&nbsp;
args.forEach(<span class="fstat-no" title="function not covered" >function (arg) {</span>
<span class="cstat-no" title="statement not covered" >  var invalid = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (var option in REGEX) {</span>
<span class="cstat-no" title="statement not covered" >    if (({}).hasOwnProperty.call(REGEX, option)) {</span>
<span class="cstat-no" title="statement not covered" >      var matches = arg.match(REGEX[option]);</span>
<span class="cstat-no" title="statement not covered" >      if (matches) {</span>
<span class="cstat-no" title="statement not covered" >        invalid = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var _matches$slice = matches.slice(1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var _matches$slice2 = _slicedToArray(_matches$slice, 1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var value = _matches$slice2[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (_commands2['default'][option]) {</span>
<span class="cstat-no" title="statement not covered" >          _commands2['default'][option].run(value);</span>
<span class="cstat-no" title="statement not covered" >          executed = true;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          flags[option] = value || option;</span>
        }
      }
    }
  }
...
<span class="cstat-no" title="statement not covered" >    _commands2['default'].unknown.run(arg);</span>
  }
});
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>if (!executed) {
...
&nbsp;
    flags.scope = global || local || current || <span class="branch-3 cbranch-no" title="branch not covered" >scope;</span>
    flags.env = prod || dev;
