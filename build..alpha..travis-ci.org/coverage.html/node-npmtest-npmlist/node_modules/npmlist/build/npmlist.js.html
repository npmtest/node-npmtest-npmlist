...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-npmlist/node_modules/npmlist/build/npmlist.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-npmlist">npmtest-npmlist (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-npmlist/node_modules/npmlist/build/npmlist.js</span></h1>
    <h2>
        
        Statements: <span class="metric">66.67% <small>(62 / 93)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">83.82% <small>(57 / 68)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-npmlist/node_modules/npmlist/build/</a> &#187; npmlist.js</div>
</div>
<div class="body">
...
&nbsp;
  return ['npm ls', '--depth=' + depth, env ? <span class="branch-0 cbranch-no" title="branch not covered" >'--' + env </span>: '', scope === 'global' ? '-g' : <span class="branch-1 cbranch-no" title="branch not covered" >'']</span>.join(' ');
}
&nbsp;
function log(level, msg) {
  switch (level) {
<span class="branch-0 cbranch-no" title="branch not covered" >    case 2:</span>
<span class="cstat-no" title="statement not covered" >      return _chalk2['default'].red(msg);</span>
<span class="branch-1 cbranch-no" title="branch not covered" >    case 1:</span>
<span class="cstat-no" title="statement not covered" >      return _chalk2['default'].yellow(msg);</span>
    default:
...
exports['default'] = {
  run: function run() {
    var flags = arguments.length &lt;= 0 || arguments[0] === undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >{} </span>: arguments[0];
&nbsp;
...
&nbsp;
      // Banner
      var type = flags.env ? <span class="branch-0 cbranch-no" title="branch not covered" >flags.env </span>: 'npm';
...
&nbsp;
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (invalidMatches) {
<span class="cstat-no" title="statement not covered" >            logLevel = 2;</span>
<span class="cstat-no" title="statement not covered" >            version = invalidMatches[1];</span>
          }
&nbsp;
          // Check for UNMET dependencies
          <span class="missing-if-branch" title="if path not taken" >I</span>if (unmetMatches) {
<span class="cstat-no" title="statement not covered" >            logLevel = 1;</span>
<span class="cstat-no" title="statement not covered" >            _name = unmetMatches[1];</span>
<span class="cstat-no" title="statement not covered" >            version = 'UNMET';</span>
          }
&nbsp;
          // Check for linked packages
          <span class="missing-if-branch" title="if path not taken" >I</span>if (versionMatches) {
<span class="cstat-no" title="statement not covered" >            logLevel = 1;</span>
<span class="cstat-no" title="statement not covered" >            version = versionMatches[1];</span>
          }
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (pkgs.length) {
...
&nbsp;
          ...
          spaces ? <span class="branch-0 cbranch-no" title="branch not covered" >_chalk2['default'].black(name) </span>: _chalk2['default'].magenta(name),
&nbsp;
          // Dotted spacing
...
<span class="cstat-no" title="statement not covered" >        var msg = _chalk2['default'].magenta('No packages found.');</span>
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Tue Apr 25 2017 05:07:31 GMT+0000 (UTC)</div>
</div>
</body>
</html>
